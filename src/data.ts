...
export const products: Product[] = [
  ...
  { id: 5, name: 'Футболка «Капкан»', collection: 'КАПКАН', description: 'Прямоугольный принт-ловушка, плотный хлопок, оверсайз.', price: 7900, colors: ['Чёрный'], sizes: ['M–L', 'XL–XXL'], sprite: 'bl' },
  { id: 6, name: 'Лонгслив «Капкан»', collection: 'КАПКАН', description: 'Удлинённый лонгслив с монохромной ловушкой.', price: 8900, colors: ['Чёрный', 'Серый'], sizes: ['M–L', 'XL–XXL'], sprite: 'bl' },
]
